...
class Band:
    ...
    def calculate_rms(self, reffreq=1300, refsig=1, gamma_p=1.6):
        ...
        rms = refsig/self.ratio_tel*np.sqrt(self.num_sub) * (self.subfreq/reffreq)**gamma_p
        self.rms = rms
        return self.rms
...
for i, parfile in enumerate(par_files):
    ...
    if args.nuhfb != 0:
        ...
        rms_uhf = UHF_Band.calculate_rms(reffreq=args.reffreq, refsig=args.refsig, gamma_p=args.refgamma)
    ...
    if args.nlb != 0:
        ...
        rms_l = L_Band.calculate_rms(reffreq=args.reffreq, refsig=args.refsig, gamma_p=args.refgamma)
    ...
    if args.nsb != 0:
        ...
        rms_s = S_Band.calculate_rms(reffreq=args.reffreq, refsig=args.refsig, gamma_p=args.refgamma)
